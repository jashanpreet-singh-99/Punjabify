...
public class ArtistCircularList3HorizontalAdapter extends Adapter<ArtistCircularList3HorizontalAdapter.ViewHolder> {

    private Context context;
    private ArrayList<String> data ;
    private OnArtistRecyclerViewClicked onArtistRecyclerViewClicked;

    public ArtistCircularList3HorizontalAdapter(Context context, OnArtistRecyclerViewClicked onArtistRecyclerViewClicked, ArrayList<String> data) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.artistBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onArtistRecyclerViewClicked.onNewArtistFollowed(position);
            }
        });
    }
